...
class clienteControlador extends clienteModelo
{
    ...
    public function agregar_cliente_controlador()
    {
        ...
        if(mainModel::verificar_datos("\d{3,8}-[\d|kK]{1}",$rut_cliente)){
        ...
        if(mainModel::verificar_datos("[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}",$nombre_cliente)){
        ...
        if(mainModel::verificar_datos("[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,35}",$apellido_cliente)){
        ...
        if(mainModel::verificar_datos("[0-9()+]{8,100}",$telefono_cliente)){
        ...
        if(mainModel::verificar_datos("[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,150}",$direccion_cliente)){
    ...
    public function eliminar_cliente_controlador()
    {
        ...
        if ($eliminar_cliente->rowCount() == 1) {
            $alerta = [
                ...
                "Texto" => "El Cliente ha sido eliminado exitosamente del sistema",
                "Tipo" => "success"
            ];
        } else {
            $alerta = [
