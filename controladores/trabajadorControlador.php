...
class trabajadorControlador extends trabajadorModelo
{
    ...
    public function agregar_trabajador_controlador()
    {
        ...
        /*== Validaciones del formulario trabajadores ==*/

        if(mainModel::verificar_datos("[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,35}",$nombre_trabajador)){

            $alerta = [
                "Alerta" => "simple",
                "Titulo" => "Ocurrio un error inesperado",
                "Texto" => "El NOMBRE NO COINCIDE CON EL FORMATO LETRAS.",
                "Tipo" => "error"
        ...
        if(mainModel::verificar_datos("[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,35}",$apellido_trabajador)){

            $alerta = [
                "Alerta" => "simple",
                "Titulo" => "Ocurrio un error inesperado",
                "Texto" => "El APELLIDO NO COINCIDE CON EL FORMATO LETRAS",
                "Tipo" => "error"
            ];
            echo json_encode($alerta);
            exit();
        ...
        if(mainModel::verificar_datos("[0-9()+]{8,100}",$telefono_trabajador)){

            $alerta = [
                "Alerta" => "simple",
                "Titulo" => "Ocurrio un error inesperado",
                "Texto" => "El TELEFONO NO COINCIDE CON EL FORMATO NUMEROS",
                "Tipo" => "error"
            ];
            echo json_encode($alerta);
            exit();
        ...
        if(mainModel::verificar_datos("[0-9()+]{2,100}",$edad_trabajador)){

            $alerta = [
                "Alerta" => "simple",
                "Titulo" => "Ocurrio un error inesperado",
                "Texto" => "LA EDAD NO COINCIDE CON EL FORMATO NUMEROS",
                "Tipo" => "error"
            ];
            echo json_encode($alerta);
            exit();
        ...
        if(mainModel::verificar_datos("[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,35}",$direccion_trabajador)){

            $alerta = [
                "Alerta" => "simple",
                "Titulo" => "Ocurrio un error inesperado",
                "Texto" => "LA DIRECCION NO COINCIDE CON EL FORMATO LETRAS",
                "Tipo" => "error"
            ];
            echo json_encode($alerta);
            exit();
        ...
        if(mainModel::verificar_datos("[0-9()+]{1,100}",$numero_casa_trabajador)){

            $alerta = [
                "Alerta" => "simple",
                "Titulo" => "Ocurrio un error inesperado",
                "Texto" => "EL NUMERO DE CASA NO COINCIDE CON EL FORMATO NUMEROS",
                "Tipo" => "error"
            ];
            echo json_encode($alerta);
            exit();
        ...
        if(mainModel::verificar_datos("\d{3,8}-[\d|kK]{1}",$rut_trabajador)){
...
if(mainModel::verificar_datos("[0-9()+]{8,100}",$telefono)){
...
if(mainModel::verificar_datos("[0-9()+]{2,100}",$edad)){
...
if(mainModel::verificar_datos("[0-9()+]{1,100}",$numero_casa)){
...
if(mainModel::verificar_datos("\d{3,8}-[\d|kK]{1}",$rut)){
