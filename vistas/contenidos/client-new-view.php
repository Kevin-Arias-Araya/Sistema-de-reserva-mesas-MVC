							...
							<div class="row">
								<div class="col-12 col-md-4">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="cliente_rut_reg" id="cliente_rut" maxlength="27">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="cliente_nombre" class="bmd-label-floating">Nombre</label>
										<input type="text" class="form-control" name="cliente_nombre_reg" id="cliente_nombre" maxlength="40">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
								...
								<div class="col-12 col-md-4">
									<div class="form-group">
										...
										<input type="password" pattern="[A-Za-z0-9!?-]{8,12}" class="form-control" name="cliente_clave_1_reg" id="cliente_clave_1" pattern="[A-Za-z0-9!?-]{8,12}" maxlength="100" required="" >
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="cliente_clave_2" class="bmd-label-floating">Repetir contraseña</label>
										<input type="password" pattern="[A-Za-z0-9!?-]{8,12}" class="form-control" name="cliente_clave_2_reg" id="cliente_clave_2" pattern="[A-Za-z0-9!?-]{8,12}" maxlength="100" required="" >
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
								...
								<div class="col-12 col-md-4">
									<div class="form-group">
										...
										<input type="text"  class="form-control" name="cliente_telefono_reg" id="cliente_telefono" maxlength="20">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="cliente_direccion" class="bmd-label-floating">Dirección</label>
										<input type="text"  class="form-control" name="cliente_direccion_reg" id="cliente_direccion" maxlength="150">
									</div>
								</div>
								<div class="col-12 col-md-4">
								<div class="form-group">
